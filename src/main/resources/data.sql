...
INSERT INTO Jobs (title, description_, location, start_date, end_date)
VALUES
	('topjob', 'best job in the world', 'London', DATE '2022-03-04', DATE '2022-03-04'),
	('topjob', 'best job in the world', 'London', DATE '2022-03-04', DATE '2022-03-04'),
	('topjob3', 'best job in the world', 'London', DATE '2022-02-04', DATE '2022-02-06'),
	('topjob4', 'best job in the world', 'London', DATE '2022-02-04', DATE '2022-02-12');


INSERT INTO Availability (start_date, end_date)
VALUES
	( DATE '2022-01-01', DATE '2022-01-07'),
	( DATE '2022-01-08', DATE '2022-01-14'),
	( DATE '2022-01-15', DATE '2022-01-21'),
	( DATE '2022-01-22', DATE '2022-01-28');
